...
%peakfit takes spectrum data and makes Lorentzian fit and find peaks
%   spectrumData is a N-by-2 matrix containing wavelength and power data
%   res is a number or an array of estimated resonance position
...
%   returns peak, a number or an array of wavelength of the minimum point
